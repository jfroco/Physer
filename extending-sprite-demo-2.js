(function(){
    ...
    (function(){
        ...
        function MonsterBunny() {
            MonsterBunny.prototype.__init__.apply(this, arguments);
        }
        ՐՏ_extends(MonsterBunny, Physer.Sprite);
        MonsterBunny.prototype.__init__ = function __init__(game, rotate_speed){
            var self = this;
            var random_scale;
            Physer.Sprite.__init__(self, game, game.world.randomX, game.world.randomY, "bunny");
            self.anchor.setTo(.5, .5);
            self.rotateSpeed = rotate_speed;
            random_scale = .1 + Physer.random();
            self.scale.setTo(random_scale, random_scale);
            game.add.existing(self);
        };
        MonsterBunny.prototype.update = function update(){
            var self = this;
